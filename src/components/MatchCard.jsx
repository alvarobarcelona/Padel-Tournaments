...
export default function MatchCard({
  ...
  const getScoreColor = (isWinner, isLoser) => {
    if (isDraw) return "white";
    if (isWinner) return "var(--primary)"; // Green
    if (isLoser) return "var(--danger)"; // Red
    return "white";
  };
  ...
  return (
    <div
      ...
      style={{ padding: "1rem", marginBottom: "1rem", position: "relative" }}
    >
      {match.court && (
        <div
          style={{
        ...
        <div style={{ flex: 1, textAlign: "center" }}>
          ...
          <div
            style={{
              fontSize: "2rem",
              fontWeight: "bold",
              color: getScoreColor(isTeam1Winner, isTeam2Winner),
            }}
          >
            {match.score1}
          </div>
        ...
        <div style={{ flex: 1, textAlign: "center" }}>
          ...
          <div
            style={{
              fontSize: "2rem",
              fontWeight: "bold",
              color: getScoreColor(isTeam2Winner, isTeam1Winner),
            }}
          >
            {match.score2}
          </div>
